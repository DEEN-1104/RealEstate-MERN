        ...
        <div className="Apt-Buy-container">
            ...
            <section className="Apt-help-section-buy">
                <div className="Apt-help-options-buy">
                    ...
                    <div className="Apt-help-option-buy">
                        <Link to="/buy" className="Apt-help-option-buy-noton">
                            <img src={homeImage} alt="House"/>
                            <p>House</p>
                        </Link>
                    </div>
                    <div className="Apt-help-option-buy">
                        <Link to="/BeachHousebuy" className="Apt-help-option-buy-noton">
                            <img src={beach} alt="Beach House"/>
                            <p>Beach House</p>
                        </Link>
                    </div>
                    <div className="Apt-help-option-buy">
                        <Link to="/PoolHousebuy" className="Apt-help-option-buy-noton">
                            <img src={poolhouse} alt="Pool House"/>
                            <p>Pool House</p>
                        </Link>
                    </div>
                    <div className="Apt-help-option-buy">
                        <Link to="/land-buy" className="Apt-help-option-buy-noton">
                            <img src={vally} alt="Land"/>
                            <p>Land</p>
                        </Link>
                    </div>
                    <div className="Apt-help-option-buy">
                        <Link to="/FarmHousebuy" className="Apt-help-option-buy-noton">
