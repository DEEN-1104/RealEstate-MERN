            ...
            <section className="BeachHouse-help-section-buy">
                <div className="BeachHouse-help-options-buy">
                    <div className="BeachHouse-help-option-buy">
                        <Link to="/Apt-buy" className="BeachHouse-help-option-buy-noton">
                            <img src={buliding} alt="Apartment"/>
                            <p >Apartment</p>
                        </Link>
                    </div>
                    <div className="BeachHouse-help-option-buy">
                        <Link to="/buy" className="BeachHouse-help-option-buy-noton">
                    ...
                    <div className="BeachHouse-help-option-buy">
                        <Link to="/PoolHousebuy" className="BeachHouse-help-option-buy-noton">
                            <img src={poolhouse} alt="Pool House"/>
                            <p>Pool House</p>
                        </Link>
                    </div>
                    <div className="BeachHouse-help-option-buy">
                        <Link to="/land-buy" className="BeachHouse-help-option-buy-noton">
