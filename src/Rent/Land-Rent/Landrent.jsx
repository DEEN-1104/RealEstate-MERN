        ...
        <div className="Land-Buy-container">
            ...
            <header className="Land-navbar-buy">
                ...
                <nav>
                    <ul className="nav-links">
                        ...
                        <li><Link to="/rent" className="LandBuy-nav-High">Rent</Link></li>
            ...
            <section className="Land-help-section-buy">
                <div className="Land-help-options-buy">
                    ...
                    <Link to="/Aptrent" className="Land-help-option-buy-noton">
                        <img src={buliding} alt="Apartment"/>
                        <p>Apartment</p>
                    </Link>
                    </div>
                    <div className="Land-help-option-buy">
                        <Link to="/rent" className="Land-help-option-buy-noton">
                        <img src={homeImage} alt="House"/>
                        <p>House</p>
                            </Link>
                    </div>
                    <div className="Land-help-option-buy">
                        <Link to="/BeachHouserent" className="Land-help-option-buy-noton">
                        <img src={beach} alt="Beach House"/>
                        <p>Beach House</p>
                            </Link>
                    </div>
                    <div className="Land-help-option-buy">
                        <Link to="/PoolHouserent" className="Land-help-option-buy-noton">
                    ...
                    <div className="Land-help-option-buy">
                        <Link to="/FarmHouserent" className="Land-help-option-buy-noton">
