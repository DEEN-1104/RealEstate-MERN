            ...
            <header className="FarmHouse-navbar-buy">
                ...
                <nav>
                    <ul className="nav-links">
                        ...
                        <li><Link to="/rent" className="FarmHouseBuy-nav-High">Rent</Link></li>
            ...
            <section className="FarmHouse-help-section-buy">
                <div className="FarmHouse-help-options-buy">
                    <div className="FarmHouse-help-option-buy">
                        <Link to="/Aptrent" className="FarmHouse-help-option-buy-noton">
                            <img src={buliding} alt="Apartment"/>
                            <p >Apartment</p>
                        </Link>
                    </div>
                    <div className="FarmHouse-help-option-buy">
                        <Link to="/rent" className="FarmHouse-help-option-buy-noton">
                            <img src={homeImage} alt="House"/>
                            <p>House</p>
                        </Link>
                    </div>
                    <div className="FarmHouse-help-option-buy">
                        <Link to="/BeachHouserent" className="FarmHouse-help-option-buy-noton">
                            <img src={beach} alt="Beach House"/>
                            <p>Beach House</p>
                        </Link>
                    </div>
                    <div className="FarmHouse-help-option-buy">
                        <Link to="/PoolHouserent" className="FarmHouse-help-option-buy-noton">
                            <img src={poolhouse} alt="Pool House"/>
                            <p>Pool House</p>
                        </Link>
                    </div>
                    <div className="FarmHouse-help-option-buy">
                        <Link to="/landrent" className="FarmHouse-help-option-buy-noton">
