            ...
            <header className="navbar-buy">
                ...
                <nav>
                    <ul className="nav-links">
                        ...
                        <li><Link to="/rent" className="Buy-nav-High">Rent</Link></li>
            ...
            <section className="help-section-buy">
                <div className="help-options-buy">
                    <div className="help-option-buy">
                        <Link to="/Aptrent" className="house-help-option-buy-noton">
                    ...
                    <div className="help-option-buy">
                        <Link to="/BeachHouserent" className="house-help-option-buy-noton">
                        <img src={beach} alt="Beach House"/>
                        <p>Beach House</p>
                        </Link>
                    </div>
                    <div className="help-option-buy">
                        <Link to="/PoolHouserent" className="house-help-option-buy-noton">
                        <img src={poolhouse} alt="Pool House"/>
                        <p>Pool House</p>
                        </Link>
                    </div>
                    <div className="help-option-buy">
                        <Link to="/landrent" className="house-help-option-buy-noton">
                        <img src={vally} alt="Land"/>
                        <p>Land</p>
                        </Link>
                    </div>
                    <div className="help-option-buy">
                        <Link to="/FarmHouserent" className="house-help-option-buy-noton">
